                                        ...
                                        <div>
                                             ...
                                             class="authentication-form">
                                                  ...
                                                  <div class="mb-1 text-center d-grid">
                                                       <button id="btnSubmit" class="btn btn-primary" type="submit">Reset Password</button>
                                                  </div>
                                             </form>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#loginForm').submit(function(e) {
                ...
                handleLoginForm('POST', '#resetPassForm', '#btnSubmit', '{{ route('forget_password') }}','{{ route('verifyOtpform') }}');
            });
        });
    </script>
