...
<div class="col-xl-12 col-lg-12 d-flex justify-content-between align-items-center">
    <h4 class="fw-bold topbar-button pe-none text-uppercase mb-2 mx-4">Edit Product Category</h4>
...
<div class="container-xxl">
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <form id="productCategoryEditForm" method="post" enctype="multipart/form-data">
                @csrf
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('#productCategoryEditForm').on('submit', function (e) {
                ...
                $.ajax({
                    url: '{{ route("admin.product.categories.update", $category->id) }}', // The route for updating
